...
public class UrlContainer {
    ...
    private static final String allReservationsUrl = "www.niagarakayak.com/kayakAPI/GetReservations.php/?api=%s&ALL=true";

    private static final String reservationUrl = "http://www.niagarakayak.com/kayakAPI/" +
            "GetReservations.php/?api=%s&customer=%s";
    private static final String postURL = "http://www.niagarakayak.com/kayakAPI/MakeReservation.php/" +
